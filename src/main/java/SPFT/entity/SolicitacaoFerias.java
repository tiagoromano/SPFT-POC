...
/**
 * Classe que representa a tabela SOLICITACAO_FERIAS
 * @generated
 */
@Entity
@Table(name = "\"SOLICITACAO_FERIAS\"", schema="\"SPFT\""  ,uniqueConstraints=@UniqueConstraint(columnNames={
"SOFE_CD_SOLICITACAO_FERIAS" }))
@XmlRootElement
@CronappSecurity
@JsonFilter("SPFT.entity.SolicitacaoFerias")
public class SolicitacaoFerias implements Serializable {
  ...
  */
   ...
   * @generated
   */
  public SolicitacaoFerias setId(java.lang.Integer id){
    this.id = id;
    return this;
  }
   ...
   * @generated
   */
  public SolicitacaoFerias setPeriodoConcessao(PeriodoConcessao periodoConcessao){
   ...
   * @generated
   */
  public SolicitacaoFerias setJustificativa(java.lang.String justificativa){
   ...
   * @generated
   */
  public SolicitacaoFerias setStatus(java.lang.Integer status){
    this.status = status;
    return this;
  }
   ...
   * @generated
   */
  public SolicitacaoFerias setUtilizaAbono(java.lang.Integer utilizaAbono){
   ...
   * @generated
   */
  public SolicitacaoFerias setAdiantaDecimo(java.lang.Integer adiantaDecimo){
   ...
   * @generated
   */
  public SolicitacaoFerias setDividir(java.lang.Integer dividir){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo1Inicio(java.util.Date dataPeriodo1Inicio){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo1Fim(java.util.Date dataPeriodo1Fim){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo2Inicio(java.util.Date dataPeriodo2Inicio){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo2Fim(java.util.Date dataPeriodo2Fim){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataAtualizacaoDate(java.util.Date dataAtualizacaoDate){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo3Inicio(java.util.Date dataPeriodo3Inicio){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataPeriodo3Fim(java.util.Date dataPeriodo3Fim){
   ...
   * @generated
   */
  public SolicitacaoFerias setDataAtualizacao(java.util.Date dataAtualizacao){
  ...
  public boolean equals(Object obj) {
    ...
    SolicitacaoFerias object = (SolicitacaoFerias)obj;
